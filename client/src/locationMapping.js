...
// curl https://vacme.kloud.top/api/locations | jq ".locations | .[]| .name" | sort > names_fetched.txt
// cat locationMapping.json | jq ".locations | .[] | .name" | sort > names_mapped.txt
// diff names_fetched.txt names_mapped.txt
...
const locations_mapping = [
    ...
    {"name": "Affoltern a.A., Vitalis Apotheke", "latitude": 47.2745075198469, "longitude":  8.446807888327584, "link": "https://g.page/vitalisapotheke"},
    {"name": "_Impfzentrum Uster", "latitude": 47.360851559068145, "longitude":  8.728580911621616, "link": "https://g.page/impfzentrum-uster"},
    ...
    {"name": "Zürich, Amavita Apotheke Schamendingen", "latitude": 47.404616624050036,"longitude":  8.57303371587817, "link": "https://g.page/amavita-schwamendingen"},
    ...
    {"name": "Zürich, Wartau Rotpunkt Apotheke", "latitude": 47.402624334779134,"longitude":  8.493384987042745, "link": "https://g.page/wartau-apotheke"},
    ...
    {"name": "Zürich, Apotheke zum Pilgerbrunnen AG", "latitude": 47.378428350486544,"longitude":  8.511287080938855, "link": "https://g.page/pilgerbrunnen"},
    ...
    {"name": "_Impfzentrum Messe Zürich", "latitude": 47.41165664956518, "longitude":  8.553435671701461, "link": "https://g.page/impfzentrum-zuerich"},
    ...
    {"name": "Zürich, Amavita Apotheke Shopville", "latitude": 47.37748264412427, "longitude":  8.539704198688627, "link": "https://g.page/amavita-shopville"},
    ...
    {"name": "Zürich, Klus-Apotheke AG - Impfzentrum", "latitude": 47.36479851999794,"longitude":  8.566626741017599, "link": "https://g.page/klus-apotheke"},
    ...
    {"name": "Zumikon, Amavita Apotheke Zumikon", "latitude": 47.33087063861493,"longitude":  8.626081846559908, "link": "https://g.page/amavita-zumikon"},
    ...
    {"name": "Winterthur, Bachtel Apotheke", "latitude": 47.50770731853323, "longitude":  8.711573000538444, "link": "https://g.page/bachtel-apotheke"},
    {"name": "Schlieren, Apotheke Lilie Zentrum", "latitude": 47.396859291805995, "longitude":  8.448335387603256, "link": "https://g.page/apotheke-lilie-zentrum"},
    ...
    {'name': "Apotheke im KSW AG", 'latitude': 47.50734501403949, 'longitude':  8.727306176373228, 'link': 'https://g.page/apotheke-im-ksw'},
    //{'name': "Zürich, Apotheke Affoltern", 'latitude': ,'longitude':  , 'link': ''},
